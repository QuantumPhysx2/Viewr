...
var map = AmCharts.makeChart("chartdiv", {
  ...
  "dataProvider": {
    ...
    "areas": [{
      ...
      "population": "0",
      "information": "The French Southern and Antarctic Lands is an overseas territory of France which consists of a group of volcanoes. Because of this, it is uninhabited by humans.",
...
map.addListener("clickMapObject", function(evt) {
  ...
  document.querySelector(".popularRestaurants1").innerHTML = "<p>" + evt.mapObject.restaurants[0] + "</p>";
  document.querySelector(".popularRestaurants2").innerHTML = "<p>" + evt.mapObject.restaurants[1] + "</p>";
